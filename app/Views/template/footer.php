        ...
        <div class="kt-container ">
            <div class="kt-footer__wrapper">
                <div class="kt-footer__copyright">
                    &copy; 2019 <a href="http://keenthemes.com/metronic" target="_blank">Keenthemes</a>
                </div>
...
<!-- end::Scrolltop -->
		...
		<script src="<?= base_url(); ?>/assets/plugins/custom/tinymce/tinymce.min.js" type="text/javascript"></script>
		<script src="<?= base_url(); ?>/assets/plugins/custom/tinymce/themes/silver/theme.js" type="text/javascript"></script>
		<script src="<?= base_url(); ?>/assets/plugins/custom/tinymce/themes/mobile/theme.js" type="text/javascript"></script>
        ...
        <script type="text/javascript">
            ...
            (function(){
                ...
                s1.async=true;
                s1.src='https://embed.tawk.to/5f26e1a04f3c7f1c910da8ef/default';
                s1.charset='UTF-8';
