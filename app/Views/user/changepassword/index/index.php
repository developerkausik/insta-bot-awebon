							...
							<div class="col-xl-12 col-lg-12 order-lg-3 order-xl-1">
								...
								<div class="kt-portlet kt-portlet--height-fluid">
									...
									<div class="kt-portlet__body kt-portlet__body--fit">
										<div class="col-sm-12">
											<form id="changePassForm" action="<?=base_url()?>/rest/user/profile/profile/changepassword" method="POST">
												...
												<div class="form-group">
													<button type="button" id="changePassword" class="btn btn-brand">Change Password</button>
												</div>
