							...
							<div class="col-xl-12 col-lg-12 order-lg-3 order-xl-1">
								...
								<div class="kt-portlet kt-portlet--height-fluid">
									...
									<div class="kt-portlet__body kt-portlet__body--fit">
										<div class="col-sm-12">
											<form id="changeEmailForm" action="<?=base_url()?>/rest/user/profile/profile/updateemail" method="POST">
												<div class="form-group">
													<label for="" class="form-control-label">Current Email ID</label>
													<input type="type" class="form-control" name="current_email">
												</div>
												<div class="form-group">
													<label for="" class="form-control-label">New Email ID</label>
													<input type="type" class="form-control" name="new_email">
												</div>
												<div class="form-group">
													<button type="button" id="changeEmail" class="btn btn-brand">Change Email</button>
												</div>
